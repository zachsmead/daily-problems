...
# 2. in this hash, 'hay:' gives the key, calling ':hay' gives a array with 6 elements
# 3. 4th element (index [3]) of that array is a hash with 1 key-value pair.
# 4. in this hash, 'hay:' gives the key, calling ':hay' gives another hash with 1 key-value pair.
# 5. in this hash, 'hay:' gives the key, calling ':hay' gives a array with 5 elements.
# 6. 2nd element (index [1]) of this array is a hash with 1 key-value pair.
# 7. in this hash, 'hay:' gives the key, calling 'hay:' gives a array with 3 elements.
